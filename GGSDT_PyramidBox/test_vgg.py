...
print('Loading model..')
vgg_net = build_vgg('test', 640, 2)
net1 = vgg_net
net1.load_state_dict(torch.load('./GGSDT_PyramidBox/weights/Vgg16_pyramid_70000x.pth'))
...
if __name__ == '__main__':
    ...
    writepath = './GGSDT_PyramidBox/results/test_final_vgg.txt'
